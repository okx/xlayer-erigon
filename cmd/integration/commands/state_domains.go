...
func (b *blockProcessor) applyBlock(
	...
	for i, tx := range block.Transactions() {
		if b.txNum >= b.startTxNum {
			...
			receipt, _, _, err := core.ApplyTransaction(b.chainConfig, getHashFn, b.engine, nil, gp, ibs, b.writer, header, tx, usedGas, b.vmConfig, parentHeader.ExcessDataGas, 100) // TODO [zkevm] - fix for build, but may need to pass correct value
			if err != nil {
