...
func (opts *MdbxOpts) Print() {
	log.Info(fmt.Sprintf(
		"MdbxOpts: Path=%s, SyncPeriod=%s, MapSize=%s, GrowthStep=%s, ShrinkThreshold=%d, Flags=%d, PageSize=%d, DirtySpace=%d, MergeThreshold=%d, Verbosity=%v, Label=%v, InMem=%v%s%s",
